...
class Stripe_subscription extends CI_Controller {
...
if(count($res) > 0 ) 
{
 ...
 $post_data='{
      "product_id": "PROD-89F83319R7476444J",
      "name": "Micro",
      "description": "Micro",
      "billing_cycles": [
        {
 ...
 $ch = curl_init();curl_setopt($ch, CURLOPT_URL, 'https://api.sandbox.paypal.com/v1/billing/plans');
 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
 curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);
 curl_setopt($ch, CURLOPT_POST, 1);
 $headers = array();
...
$post_data='{
  "url": "https://featherpet.com/feedback_email_system/paypal/get_webhook_data/",
  "event_types": [
    {
...
$ch = curl_init();curl_setopt($ch, CURLOPT_URL, 'https://api.sandbox.paypal.com/v1/notifications/webhooks');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);
curl_setopt($ch, CURLOPT_POST, 1);
$headers = array();
