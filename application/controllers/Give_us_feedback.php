...
class Give_us_feedback extends CI_Controller {
  ...
  public function index()
  {
      ...
      $this->load->view('UI/give_us_feedback');
  ...
  public function save_template()
  {
    if(!empty($_POST['template_data']))
    {
	   ...
	   //print_r($res[0]['scr_uname']);
	        $msg="<p>Email: ".$email."</p>";
           $msg.="<p>Subject: Feeback From Customer</p>";
   ...
   // $msg=$this->parser->parse_string($msg,$dt,TRUE);
      ...
      $this->email->subject('Feeback From Customer');
      $this->email->message($msg);
      if ($this->email->send()) 
      {
           echo '{"status_code":"1","status_text":"Thanks For Your Feedback."}'; 
      }
      else 
      {
