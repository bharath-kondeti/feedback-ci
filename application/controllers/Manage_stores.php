...
class Manage_stores extends CI_Controller {
  ...
  $sql="SELECT * FROM scr_user as a INNER JOIN store_access as b ON a.scr_u_id=b.user_id INNER JOIN amazon_profile AS c on c.store_id=b.store_id  INNER JOIN store_manager AS d ON c.store_id=b.store_id WHERE d.country_code='".$_POST['country_code']."' AND a.scr_u_id='".$this->user_id."'  GROUP BY scr_u_id";
  ...
  {
    echo '{"status_code":"0","status_text":"Store Not added to delete","SQL":"'.$sql.'"}';
  }
