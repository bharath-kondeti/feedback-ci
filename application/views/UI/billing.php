...
.stripe-button-el  {
                                        ...
                                        <div class="media justify-content-between">
                                            <div>
                                               <p class="">Subscription</p>
                                                <h2 ng-if="stripe_plan.sub_status_new.length > 0" class="font-size-28 font-weight-light">{{stripe_plan.sub_status_new}}</h2>
												<h2 ng-if="stripe_plan.status_new2=='Inactive' && paypal_details.status_new=='Inactive'" class="font-size-28 font-weight-light">Inactive</h2>
												<h2 ng-if="paypal_details.sub_status_new2.length > 0" class="font-size-28 font-weight-light">{{paypal_details.sub_status_new2}}</h2>
                                            </div>
                                            ...
                                            <div class="card-body text-center">
                                               <!-- <p class="card-pricing-plan-name font-weight-bold text-uppercase">Professional Pack</p>  -->
                                                ...
                                                <ul class="card-pricing-features">
												 ...
												 <button ng-if="stripe_plan.sub_status=='active' && stripe_plan.plan_name=='Micro'"  ng-click='cancel_stripe_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												 
												  <button ng-if="paypal_details.status =='ACTIVE' && paypal_details.plan_name=='Micro'"   ng-click='cancel_payapal_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												  
											    <button ng-if="stripe_plan.status_new2 =='Inactive'"   ng-click='load_money_using_razor_pay(1)' class="btn btn-primary waves-effect waves-light mt-4 mb-2 width-sm">Pay With Stripe</button>
												
												 <button ng-if="paypal_details.status_new =='Inactive' "   ng-click='subscribe(1)' class="btn btn-warning waves-effect waves-light mt-4 mb-2 width-sm">Pay With Paypal</button>
  ...
  <button ng-if="stripe_plan.sub_status=='active' && stripe_plan.plan_name=='Small'"  ng-click='cancel_stripe_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												 
												  <button ng-if="paypal_details.status =='ACTIVE' && paypal_details.plan_name=='Small'"   ng-click='cancel_payapal_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												  
											    <button ng-if="stripe_plan.plan_name!='Small'"  ng-click='load_money_using_razor_pay(1)' class="btn btn-primary waves-effect waves-light mt-4 mb-2 width-sm">Pay With Stripe</button>
                                        ...
                                        <div class="card card-pricing card-pricing-recommended">
                                            <div class="card-body text-center">
                                             <!--   <p class="card-pricing-plan-name font-weight-bold text-uppercase">Business Pack</p> -->
                                                ...
                                                <h2 class="card-pricing-price text-white">3 <span>/ Month</span></h2>
                                                <ul class="card-pricing-features">
                                                     <li>10,000 Emails </li>
                                                    <li>7 Market Places  </li>
                                                    <li>Unlimited Campaigns  </li>
												 ...
												 <button ng-if="stripe_plan.sub_status=='active' && stripe_plan.plan_name=='Medium'"  ng-click='cancel_stripe_subscription()' class="btn btn-light waves-effect waves-effect mt-4 mb-2 width-sm">Active Plan</button>
												 
												  <button ng-if="paypal_details.status =='ACTIVE' && paypal_details.plan_name=='Medium'"   ng-click='cancel_payapal_subscription()' class="btn btn-light waves-effect waves-effect mt-4 mb-2 width-sm">Active Plan</button>
												  
												  
												   <button ng-if="stripe_plan.plan_name!='Medium'"   ng-click='load_money_using_razor_pay(1)' class="btn btn-light waves-effect waves-light mt-4 mb-2 width-sm">Pay With Stripe</button>
												
												 <button ng-if="paypal_details.status_new =='Inactive'"   ng-click='subscribe(1)' class="btn btn-light waves-effect waves-light mt-4 mb-2 width-sm">Pay With Paypal</button>
   ...
   <button ng-if="stripe_plan.sub_status=='active' && stripe_plan.plan_name=='Large'"  ng-click='cancel_stripe_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												 
												  <button ng-if="paypal_details.status =='ACTIVE' && paypal_details.plan_name=='Large'"   ng-click='cancel_payapal_subscription()' class="btn btn-success waves-effect waves-light mt-4 mb-2 width-sm">Active Plan</button>
												  
											    <button ng-if="stripe_plan.plan_name!='Large'"   ng-click='load_money_using_razor_pay(1)' class="btn btn-primary waves-effect waves-light mt-4 mb-2 width-sm">Pay With Stripe</button>
...
                 token: function(response)
              ...
              // var amt=parseInt($scope.load_amt)+parseInt($scope.tax_amt);
		        	 acFactory.capture_payment($scope.load_amt,$scope.tax_amt,response.id,plan_id)
              		.success(
                      function( html )
                      {
                      	   $.unblockUI();
