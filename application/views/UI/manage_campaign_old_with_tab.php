...
<li  id="l1"     ng-click="tb.currentTab='tab1'"  >
...
<a href="javascript: void(0);" ng-click="togggle_tab2()" class="btn btn-secondary">Next</a>
</li>
</ul>
...
<li class="next list-inline-item float-right">
<a href="javascript: void(0);" class="btn btn-secondary" ng-click="togggle_tab3()">Next</a>
</li>
</ul>
					   </div>  
...
<li class="next list-inline-item float-right">
<a href="javascript: void(0);" class="btn btn-secondary"  ng-click="togggle_tab4()">Next</a>
</li>
</ul>				   
...
<li class="next list-inline-item float-right">
<a href="javascript: void(0);" class="btn btn-secondary" ng-click="togggle_tab5()">Next</a>
</li>
</ul>
					   </div>
</div>
