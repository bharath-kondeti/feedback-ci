...
?>
<script src="<?php
echo $baseurl . '/asset/js/chart.bundle.min.js';
?>"></script>
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            ...
            <h4 class="page-title">Feedbacks Page</h4>
          </div>
        </div>
      </div>
      <!-- end page title -->
            ...
            <div class="row">
              <div class="col-md-10 col-xs-10 col-sm-10">
                <ul class="nav nav-tabs nav-bordered">
                  <li class="nav-item">
                    <a href="#all" data-toggle="tab" aria-expanded="false" class="nav-link active">All</a>
                  </li>
                  <li class="nav-item">
