				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box">
							...
							<h4 class="page-title settings-border">Change Password</h4>
						</div>
					</div>
				</div>
							...
							<div class="card-box">
								<div class="col-sm-6">
									<form novalidate="" name="pwdForm" ng-submit="update_password()"
										...
										<div class="col-md-12"
											ng-class="{ 'has-error' : pwdForm.cur_pwd.$invalid &amp;&amp; pwd_submitted  }">
											<div class="form-group">
												<label for="cur_pwd">Current Password</label>
												<input type="password" required="" ng-model="pwd.cur_pwd" placeholder="Current Password"
													name="cur_pwd" class="form-control">
											</div>
										</div>

										<div class="col-md-12"
											ng-class="{ 'has-error' : pwdForm.new_pwd.$invalid &amp;&amp; pwd_submitted  }">
											<div class="form-group">
												<label for="new_pwd">New Password</label>
												<input type="password" required="" ng-model="pwd.new_pwd" placeholder="New Password"
													name="new_pwd" class="form-control">
											</div>
										</div>

										<div class="col-md-12"
											ng-class="{ 'has-error' : pwdForm.reenter_pwd.$invalid &amp;&amp; pwd_submitted  }">
											<div class="form-group">
												<label for="reenter_pwd">Re-Enter New Password</label>
												<input type="password" required="" ng-model="pwd.reenter_pwd" placeholder="Re-Enter Password"
													name="reenter_pwd" class="form-control">
											</div>
										</div>

										<div class="col-md-12">
											<button type="submit" class="btn btn-success waves-effect waves-light mt-2"
												ng-click="pwd_submitted=true" value="Change Password" name="submit"><i
