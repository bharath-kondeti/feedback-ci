												...
												<div class="col-md-2 col-xl-2">
													<div class="widget-rounded-circle card-box">
														<div class="row">
															<div class="col-12">
																<div class="text-center">
																	<h3 class="mt-1 text-success"><span >{{fbk_data.feedback_count}}</span></h3>
												...
												<div class="col-md-2 col-xl-2">
													<div class="widget-rounded-circle card-box">
														<div class="row">
															<div class="col-12">
																<div class="text-center">
																	<h3 class="mt-1 text-primary"><span >{{fbk_data.feedback_count}}</span></h3>
												...
												<div class="col-md-2 col-xl-2">
													<div class="widget-rounded-circle card-box">
														<div class="row">
															<div class="col-12">
																<div class="text-center">
																	<h3 class="text-danger mt-1"><span >{{fbk_data.feedback_count}}</span></h3>
										...
										<div class="tab-content" ng-show="selectedTab == 2" id="reviews">
											<div class="col-md-6 offset-3">
												<div class="card-box ribbon-box">
													<div class="ribbon ribbon-warning float-right"><i class="mdi mdi-access-point mr-1"></i> <a href="<?php echo $baseurl.'manage_campaign'?>">Get Started for Free</a></div>
													<h4 class="text-primary float-left mt-0">Track your products and stay on top of reviews</h4>
													<div class="ribbon-content">
															<p class="header-title">If you're a private label seller, manufacturer or distributor of your own products, you'll know how valuable FeedbackExpress is in helping you get more Amazon product reviews,</p>
															<h4 class="text-center">But now you can.</h4>
															<ul class="tick">
																<li>Track product reviews on chosen products</li>
																<li>Get negative review alerts via email and SMS</li>
																<li>Reply to and query reviews</li>
																<li>Dynamically incorporate product images and product short names into emails for more product reviews</li>
															</ul>
															<div class="text-center">
																<a href="<?php echo $baseurl.'manage_campaign'?>" class="btn btn-md btn-primary waves-effect waves-light">Get Started for Free</a>
															</div>
															<p class="text-center">You can track 3 ASINs for free forever, and up to 20 for free duting your trial</p>
															<p class="text-center">To track more products, simply add a review bundle to your plan</p>
													</div>
												</div>
											</div>
										</div>
