                    ...
                    <div class="container-fluid">
								  ...
								  <div class="col-sm-12">
								   ...
								   <form  novalidate="" name="amzForm" ng-submit="update_amazon_api()" class="ng-pristine ng-valid ng-valid-required">
                                                   ...
                                                   <div class="form-group p-v-5">
                                                    ...
                                                    <div  class="col-sm-12" ng-class="{ 'has-error' : amzForm.user_name.$invalid &amp;&amp; amz_submitted  }">
                                               ...
                                               <div   class="col-sm-12" ng-class="{ 'has-error' : amzForm.scr_uname.$invalid &amp;&amp; amz_submitted  }">
												  ...
												  <div class="form-group p-v-5" >
                                                  <div  class="col-sm-12" ng-class="{ 'has-error' : amzForm.scr_add_email.$invalid &amp;&amp; amz_submitted  }">
													  <label class="control-label col-sm-4" >Additional Emails for Notifications</label>
													  <div class="col-sm-8" style="float:right;">
                      <input type="text" ng-model="amz_api.scr_add_email" placeholder="Additional Email" name="scr_add_email" class="form-control">
                                           ...
                                           <div class="form-group p-v-5">
                                                    ...
                                                    <div  class="col-sm-12" ng-class="{ 'has-error' : amzForm.mobile_no.$invalid &amp;&amp; amz_submitted  }">
													  <label class="control-label col-sm-4" >Contact Phone Number</label>
													  <div class="col-sm-8" style="float:right;">
                                                 ...
                                                 <div class="form-group p-v-5">
                                                    ...
                                                    <div  class="col-sm-12" ng-class="{ 'has-error' : amzForm.com_addr.$invalid &amp;&amp; amz_submitted  }">
                                                   ...
                                                   <input type="text" ng-model="amz_api.com_addr" placeholder="Company Address" name="com_addr" class="form-control">
                                                    ...
                                                    <div  class="col-sm-12" >
													  <label class="control-label col-sm-4" >Home Country VAT No</label>
													  <div class="col-sm-8" style="float:right;">
                                                   <input type="text" ng-model="amz_api.home_vat" placeholder="VAT No" name="home_vat" class="form-control">
                                                    ...
                                                    <div  class="col-sm-12" >
													  <label class="control-label col-sm-4" >All EU VAT Nos</label>
													  <div class="col-sm-8" style="float:right;">
